...
export class AssignGroupToResourceDialogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.asInactiveHint = this.translate.instant('DIALOGS.ASSIGN_GROUP_TO_RESOURCE.INACTIVE_OFF_HINT');
  ...
  changeInactiveMessage() {
    this.asInactiveHint = this.asInactive ?
      this.translate.instant('DIALOGS.ASSIGN_GROUP_TO_RESOURCE.INACTIVE_OFF_HINT') :
      this.translate.instant('DIALOGS.ASSIGN_GROUP_TO_RESOURCE.INACTIVE_ON_HINT');
  }

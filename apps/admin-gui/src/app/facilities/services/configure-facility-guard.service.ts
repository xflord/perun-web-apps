...
export class ConfigureFacilityGuardService implements CanActivate, CanDeactivate<FacilityConfigurationPageComponent>{
  ...
  canDeactivate(component: FacilityConfigurationPageComponent): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {

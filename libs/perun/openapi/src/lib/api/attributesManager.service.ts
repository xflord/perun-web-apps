...
export class AttributesManagerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAttributePolicyCollections(attributeId: number, observe?: 'body', reportProgress?: boolean): Observable<Array<AttributePolicyCollection>>;
    public getAttributePolicyCollections(attributeId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<AttributePolicyCollection>>>;
    public getAttributePolicyCollections(attributeId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<AttributePolicyCollection>>>;
    public getAttributePolicyCollections(attributeId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<AttributePolicyCollection>>(`${this.configuration.basePath}/json/attributesManager/getAttributePolicyCollections`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public setAttributePolicyCollections(inputAttributePolicyCollections: InputAttributePolicyCollections, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public setAttributePolicyCollections(inputAttributePolicyCollections: InputAttributePolicyCollections, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public setAttributePolicyCollections(inputAttributePolicyCollections: InputAttributePolicyCollections, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public setAttributePolicyCollections(inputAttributePolicyCollections: InputAttributePolicyCollections, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/json/attributesManager/setAttributePolicyCollections`,

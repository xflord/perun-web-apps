...
export class UsersManagerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public isLoginAvailable(loginNamespace: string, login: string, observe?: 'body', reportProgress?: boolean): Observable<number>;
    public isLoginAvailable(loginNamespace: string, login: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<number>>;
    public isLoginAvailable(loginNamespace: string, login: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<number>>;
    public isLoginAvailable(loginNamespace: string, login: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (loginNamespace === null || loginNamespace === undefined) {
        ...
        return this.httpClient.post<number>(`${this.configuration.basePath}/urlinjsonout/usersManager/isLoginAvailable`,
            null,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public reserveRandomPassword(user: number, namespace: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public reserveRandomPassword(user: number, namespace: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public reserveRandomPassword(user: number, namespace: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public reserveRandomPassword(user: number, namespace: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (user === null || user === undefined) {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/urlinjsonout/usersManager/reserveRandomPassword`,
            null,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,

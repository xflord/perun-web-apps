...
export type MailType = 'APP_CREATED_USER' | 'APPROVABLE_GROUP_APP_USER' | 'APP_CREATED_VO_ADMIN' | 'MAIL_VALIDATION' | 'APP_APPROVED_USER' | 'APP_REJECTED_USER' | 'APP_ERROR_VO_ADMIN' | 'USER_INVITE';

export const MailType = {
    APPCREATEDUSER: 'APP_CREATED_USER' as MailType,
    APPROVABLEGROUPAPPUSER: 'APPROVABLE_GROUP_APP_USER' as MailType,

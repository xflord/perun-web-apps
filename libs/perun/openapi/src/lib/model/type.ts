 ...
 */
export type Type = 'HTML_COMMENT' | 'SUBMIT_BUTTON' | 'AUTO_SUBMIT_BUTTON' | 'FROM_FEDERATION_SHOW' | 'FROM_FEDERATION_HIDDEN' | 'PASSWORD' | 'VALIDATED_EMAIL' | 'TEXTFIELD' | 'TEXTAREA' | 'CHECKBOX' | 'RADIO' | 'SELECTIONBOX' | 'COMBOBOX' | 'USERNAME' | 'HEADING' | 'TIMEZONE' | 'EMBEDDED_GROUP_APPLICATION';
...
export const Type = {
    ...
    EMBEDDEDGROUPAPPLICATION: 'EMBEDDED_GROUP_APPLICATION' as Type
};

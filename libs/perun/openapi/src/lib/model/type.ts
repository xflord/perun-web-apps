 ...
 */
export type Type = 'HTML_COMMENT' | 'SUBMIT_BUTTON' | 'AUTO_SUBMIT_BUTTON' | 'PASSWORD' | 'VALIDATED_EMAIL' | 'TEXTFIELD' | 'TEXTAREA' | 'CHECKBOX' | 'RADIO' | 'SELECTIONBOX' | 'COMBOBOX' | 'USERNAME' | 'HEADING' | 'TIMEZONE' | 'EMBEDDED_GROUP_APPLICATION';
